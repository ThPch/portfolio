<template>
  ...
  <button @click="selectedScreen = 'sent'"
          :disabled="selectedScreen == 'sent'">Sent</button>
  ...
  export default {
    ...
    // async setup(){
      ...
      let data = {"emails": [
        ...
        {
          "id": 5,
          "from": "thpch@email.com",
          "to": "anthony@vuejsdevelopers.com",
          "subject": "RE :'Vue 3 Release Roadmap' + 6 more must-read articles from this week",
          "body": "Could you give me more homework please ? haha jk, thank for the articles btw",
          "sentAt": "2022-01-01T19:25:43.511Z",
          "archived": false,
          "read": false,
          "sent": true
        },
        {
          "id": 6,
          "from": "thpch@email.com",
          "to": "damian@dulisz.com",
          "subject": "RE : #177: Updated Vue.js Roadmap; Vuex v4.0.0-alpha.1 has been released; Kia King Ishii join the core team; Nuxt v2.12 released; Videos from Vue.js Amsterdam 2020 are here!",
          "body": "Sheeeeeeeesh !! Congrats !! Hardwork pays off !! I'm proud of you guys !!",
          "sentAt": "2022-01-01T19:25:43.511Z",
          "archived": false,
          "read": false,
          "sent": true
    ...
    computed: {
      ...
      filteredEmails() {
        if(this.selectedScreen == 'inbox') {
          return this.sortedEmails.filter(e => !e.archived && !e.sent)
        } else if (this.selectedScreen == 'archive'){
          return this.sortedEmails.filter(e => e.archived)
        } else {
          return this.sortedEmails.filter(e => e.sent)
        }
      }
    },
    methods: {
